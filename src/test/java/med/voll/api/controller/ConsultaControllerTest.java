...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deve retornar status 400 quando informacoes invalidas")
    @WithMockUser
    void agendar_cenario1() throws Exception {
       var resp =  mvc.perform(post("/consultas")).andReturn().getResponse();
    ...
    @Test
    @DisplayName("Deve retornar status 200 quando informacoes validas")
    @WithMockUser
