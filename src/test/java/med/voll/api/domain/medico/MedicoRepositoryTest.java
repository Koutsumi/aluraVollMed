...
@ActiveProfiles("test") // para ler o application-test.properties e usar o banco de test
class MedicoRepositoryTest {
    ...
    @Test
    @DisplayName("Deve devolver null quando medico cadastrado não está disponível")
    void escolherMedicoAleatorioDisponivelCenario1() {
        ...
        var paciente = cadastrarPaciente("Paciente", "paciente@teste.com", "12312312332");
    ...
    @Test
    @DisplayName("Deve devolver medico está disponível na data")
